...
Public Class CLineTypeParameter
...
#Region "Private Variable"
    ...
    'During Dispense --------------------------------------------
    'Private _DuringDispenseGap As Decimal 'Pre  'Eason 20170117 Ticket:100010 , Change Variable
    Private _DuringDispenseSpeed As Decimal
    Private _DuringShutOffDistance As Decimal
    'Private _DuringSuckBack As Decimal 'Post 'Eason 20170117 Ticket:100010 , Change Variable
    'Private _DuringDwellTime As Decimal 'Post 'Eason 20170117 Ticket:100010 , Change Variable
    'Post Dispense --------------------------------------------
...
#Region "Public Function"
    ...
    Public Function Save(ByVal fileName As String) As Boolean
        Try
            ...
            'SaveIniString(strSection, "DuringSuckBack", _PostSuckBack, fileName) 'Eason 20170117 Ticket:100010 , Change Variable
            'SaveIniString(strSection, "DuringDwellTime", _PostDwellTime, fileName) 'Eason 20170117 Ticket:100010 , Change Variable
    ...
    Public Function Load(ByVal fileName As String) As Boolean
        Try
            ...
            '_PreDispenseGap = Val(ReadIniString(strSection, "DuringDispenseGap", fileName, 0.0))
            _DuringShutOffDistance = Val(ReadIniString(strSection, "DuringShutOffDistance", fileName, 0))
            '_PostSuckBack = Val(ReadIniString(strSection, "DuringSuckBack", fileName, 0.0))
            '_PostDwellTime = Val(ReadIniString(strSection, "DuringDwellTime", fileName, 0.0))

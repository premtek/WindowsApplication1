...
Friend Class NativeMethods
    Friend Declare Unicode Function WritePrivateProfileString Lib "kernel32" Alias "WritePrivateProfileStringW" (ByVal lpApplicationName As String, ByVal lpKeyName As String, ByVal lpString As String, ByVal lpFileName As String) As Long
    Friend Declare Unicode Function GetPrivateProfileString Lib "kernel32" Alias "GetPrivateProfileStringW" (ByVal lpApplicationName As String, ByVal lpKeyName As String, ByVal lpDefault As String, ByVal lpReturnedString As String, ByRef nSize As Long, ByVal lpFileName As String) As Long
End Class
Public Module MReadSaveIni
    ...
    Public Function ReadIniString(ByVal Section As String, ByVal KeyName As String, ByVal FileName As String, Optional ByVal DefualValue As String = "", Optional ByVal BufferSize As Long = 1024) As String
        ...
        lngLen = NativeMethods.GetPrivateProfileString(Section, KeyName, DefualValue, strReturnedString, BufferSize, FileName)
...
ErrExit:
    ...
    Public Function SaveIniString(ByVal Section As String, ByVal KeyName As String, ByVal KeyValue As String, ByVal FileName As String) As Long
        ...
        SaveIniString = NativeMethods.WritePrivateProfileString(Section, KeyName, KeyValue, FileName)

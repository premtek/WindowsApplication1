...
namespace Premtek
{
    /// <summary>Recipe步驟 弧中點參數</summary>
    public class CRecipeStepArcMid : IDisposable
    {
        /// <summary>終點</summary>
        ...
        /// </summary>
        /// <returns></returns>
        public CRecipeStepArcMid Clone()
        {
            CRecipeStepArcMid _Temp = new CRecipeStepArcMid();
        ...
        public ErrorCode Save(string patternName, int stepNo, string fileName)
        {
            ...
            string _KeyNameStart = "Step" + (stepNo + 1).ToString() + "_ArcMid_";

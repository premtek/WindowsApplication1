...
namespace Premtek
{
    /// <summary>圓限制條件
    /// </summary>
    public static class CRecipeStepCircleLimit
    {
        /// <summary>弧至少3點
        /// </summary>
        ...
        public static ErrorCode GetDotLimit(decimal length, decimal radius, decimal acc, decimal cycleTime, out int dotmin, out int dotmax)
        {
            ...
            _dotmin1 = (int)(length / _pitchmax);
            _dotmax1 = (int)(length / _pitchmin);
            ...
            _dotmin2 = (int)(length / _pitchmax1);
            _dotmax2 = (int)(length / _pitchmin1);
        ...
        public static ErrorCode GetVelLimit(decimal length, decimal radius, decimal acc, decimal cycleTime, out decimal velmin, out decimal velmax)
        {
            ...
            decimal _pitchmax1 = Math.Min(_pitchmax, length / (_Dotmin));
            if (cycleTime <= 0)
            {
                velmin = 0;
                velmax = 0;

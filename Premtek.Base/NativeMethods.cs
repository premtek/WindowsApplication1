...
namespace Premtek.Base
{
	...
	{
		LJV7IF_MEASURE_DATA_INFO_VALID = 0x0,
// Valid
		LJV7IF_MEASURE_DATA_INFO_ALARM = 0x1,
// Alarm value
		LJV7IF_MEASURE_DATA_INFO_WAIT = 0x2
// Judgment wait value
	}
}
namespace Premtek.Base
{
	...
	{
		LJV7IF_JUDGE_RESULT_HI = 0x1,
// HI
		LJV7IF_JUDGE_RESULT_GO = 0x2,
// GO
		LJV7IF_JUDGE_RESULT_LO = 0x4
// LO
	}
}
namespace Premtek.Base
...
namespace Premtek.Base
{
	...
	internal class NativeMethods
	{
		...
		/// </summary>
		static internal int MeasurementDataCount {
			get { return 16; }
		}
		...
		/// </summary>
		static internal UInt32 EnvironmentSettingSize {
			get { return 60; }
		}
		...
		/// </summary>
		static internal UInt32 CommonSettingSize {
			get { return 12; }
		}
		...
		/// </summary>
		static internal UInt32 ProgramSettingSize {
			get { return 10932; }
		}

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_Initialize();

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_Finalize();

		[DllImport("LJV7_IF.dll")]
		static internal extern uint LJV7IF_GetVersion();

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_UsbOpen(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_EthernetOpen(int lDeviceId, ref LJV7IF_ETHERNET_CONFIG ethernetConfig);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_CommClose(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_RebootController(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_RetrunToFactorySetting(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetError(int lDeviceId, byte byRcvMax, ref byte pbyErrCnt, IntPtr pwErrCode);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_ClearError(int lDeviceId, short wErrCode);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_Trigger(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_StartMeasure(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_StopMeasure(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_AutoZero(int lDeviceId, byte byOnOff, uint dwOut);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_Timing(int lDeviceId, byte byOnOff, uint dwOut);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_Reset(int lDeviceId, uint dwOut);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_ClearMemory(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_SetSetting(int lDeviceId, byte byDepth, LJV7IF_TARGET_SETTING TargetSetting, IntPtr pData, uint dwDataSize, ref uint pdwError);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetSetting(int lDeviceId, byte byDepth, LJV7IF_TARGET_SETTING TargetSetting, IntPtr pData, uint dwDataSize);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_InitializeSetting(int lDeviceId, byte byDepth, byte byTarget);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_ReflectSetting(int lDeviceId, byte byDepth, ref uint pdwError);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_RewriteTemporarySetting(int lDeviceId, byte byDepth);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_CheckMemoryAccess(int lDeviceId, ref byte pbyBusy);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_SetTime(int lDeviceId, ref LJV7IF_TIME time);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetTime(int lDeviceId, ref LJV7IF_TIME time);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_ChangeActiveProgram(int lDeviceId, byte byProgNo);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetActiveProgram(int lDeviceId, ref byte pbyProgNo);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetMeasurementValue(int lDeviceId, 		[Out()]
LJV7IF_MEASURE_DATA[] pMeasureData);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetProfile(int lDeviceId, ref LJV7IF_GET_PROFILE_REQ pReq, ref LJV7IF_GET_PROFILE_RSP pRsp, ref LJV7IF_PROFILE_INFO pProfileInfo, IntPtr pdwProfileData, uint dwDataSize);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetBatchProfile(int lDeviceId, ref LJV7IF_GET_BATCH_PROFILE_REQ pReq, ref LJV7IF_GET_BATCH_PROFILE_RSP pRsp, ref LJV7IF_PROFILE_INFO pProfileInfo, IntPtr pdwBatchData, uint dwDataSize);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetProfileAdvance(int lDeviceId, ref LJV7IF_PROFILE_INFO pProfileInfo, IntPtr pdwProfileData, uint dwDataSize, 		[Out()]
LJV7IF_MEASURE_DATA[] pMeasureData);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetBatchProfileAdvance(int lDeviceId, ref LJV7IF_GET_BATCH_PROFILE_ADVANCE_REQ pReq, ref LJV7IF_GET_BATCH_PROFILE_ADVANCE_RSP pRsp, ref LJV7IF_PROFILE_INFO pProfileInfo, IntPtr pdwBatchData, uint dwDataSize, 		[Out()]
LJV7IF_MEASURE_DATA[] pBatchMeasureData, 		[Out()]
LJV7IF_MEASURE_DATA[] pMeasureData);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_StartStorage(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_StopStorage(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetStorageStatus(int lDeviceId, ref LJV7IF_GET_STRAGE_STATUS_REQ pReq, ref LJV7IF_GET_STRAGE_STATUS_RSP pRsp, ref LJV7IF_STORAGE_INFO pStorageInfo);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetStorageData(int lDeviceId, ref LJV7IF_GET_STORAGE_REQ pReq, ref LJV7IF_STORAGE_INFO pStorageInfo, ref LJV7IF_GET_STORAGE_RSP pRsp, IntPtr pdwData, uint dwDataSize);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetStorageProfile(int lDeviceId, ref LJV7IF_GET_STORAGE_REQ pReq, ref LJV7IF_STORAGE_INFO pStorageInfo, ref LJV7IF_GET_STORAGE_RSP pRes, ref LJV7IF_PROFILE_INFO pProfileInfo, IntPtr pdwData, uint dwDataSize);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_GetStorageBatchProfile(int lDeviceId, ref LJV7IF_GET_BATCH_PROFILE_STORAGE_REQ pReq, ref LJV7IF_STORAGE_INFO pStorageInfo, ref LJV7IF_GET_BATCH_PROFILE_STORAGE_RSP pRes, ref LJV7IF_PROFILE_INFO pProfileInfo, IntPtr pdwData, uint dwDataSize, ref uint pTimeOffset, 		[Out()]
LJV7IF_MEASURE_DATA[] pMeasureData);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_HighSpeedDataUsbCommunicationInitalize(int lDeviceId, HighSpeedDataCallBack pCallBack, uint dwProfileCnt, uint dwThreadId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_HighSpeedDataEthernetCommunicationInitalize(int lDeviceId, ref LJV7IF_ETHERNET_CONFIG pEthernetConfig, ushort wHighSpeedPortNo, HighSpeedDataCallBack pCallBack, uint dwProfileCnt, uint dwThreadId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_PreStartHighSpeedDataCommunication(int lDeviceId, ref LJV7IF_HIGH_SPEED_PRE_START_REQ pReq, ref LJV7IF_PROFILE_INFO pProfileInfo);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_StartHighSpeedDataCommunication(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_StopHighSpeedDataCommunication(int lDeviceId);

		[DllImport("LJV7_IF.dll")]
		static internal extern int LJV7IF_HighSpeedDataCommunicationFinalize(int lDeviceId);
	}
}
#endregion

...
namespace Premtek
{
    ...
    /// <summary>DI卡-1756</summary>
    /// <remarks></remarks>
    public class CDI_PCI_1756 : IDIInterface
    {
        ...
        public bool Initial(string deviceDescription)
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Windows.Forms.MessageBox.Show(MDateLog.gMsgHandler.GetMessage(EqpID.Error_1004000) + ex.Message, "PCI-1756", System.Windows.Forms.MessageBoxButtons.OK);
                return false;
            }
        }
